const NOME = "Rafael Costa Teixeira";
let tituloProfissional = "Quase Dev";
let minhaBio = "Sou um cara esforçado, gente boa!";
...
if (btnVisual && btnLogica && resultadoQuiz) {
    btnVisual.addEventListener("click", function() {
        ...
        resultadoQuiz.innerHTML = `
            ...
            Você é apaixonado por design, experiência do usuário e adora criar interfaces bonitas e funcionais.
            Tecnologias pra você: HTML, CSS, JavaScript, React, Vue.
        `;
    ...
    btnLogica.addEventListener("click", function() {
        ...
        resultadoQuiz.innerHTML = `
            ...
            Você é fascinado por lógica, estrutura de dados e adora trabalhar nos bastidores para garantir que tudo funcione perfeitamente.
            Tecnologias pra você: Node.js, Python, Java, SQL.
        `;
